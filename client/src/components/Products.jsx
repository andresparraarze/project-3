...
const product = {
    ...
    images: [
      {
        src: 'https://balenciaga.dam.kering.com/m/24030ae52ecc4eef/Large-693949TMVJ61055_F.jpg?v=3',
        alt: 'plain long sleeve shirt.',
      },
      {
        src: 'https://balenciaga.dam.kering.com/m/4a1b0fb7f50c00ba/Large-693949TMVJ61055_I.jpg?v=3',
        alt: 'Model on the side wearing the plain long sleeve shirt.',
      },
      {
        src: 'https://balenciaga.dam.kering.com/m/1ca4bfc858250158/Large-693949TMVJ61055_D.jpg?v=3',
        alt: 'Long sleeve shirt view from the back.',
      },
      {
        src: 'https://balenciaga.dam.kering.com/m/58febb3faffff5ae/Large-693949TMVJ61055_G.jpg?v=3',
        alt: 'Model wearing plain long sleeve shirt big shot.',
      },
    ],
    colors: [
        ...
        <nav aria-label="Breadcrumb">
          <ol className="max-w-2xl mx-auto px-4 flex items-center space-x-2 sm:px-6 lg:max-w-7xl lg:px-8">
            ...
            <li className="text-sm">
              <a href={product.href} aria-current="page" className="font-medium text-gray-700 hover:text-gray-400">
                {product.name}
              </a>
            </li>
          </ol>
            ...
            <form className="mt-10">
              ...
              <div className="mt-10">
                <div className="flex items-center justify-between">
                  ...
                  <a href="/" className="text-sm font-medium text-yellow-600 hover:text-yellow-400">
                    Size guide
                  </a>
                </div>
